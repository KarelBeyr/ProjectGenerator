    ...
    public class DataModel
    {
        ...
        public Class AddClass(Type type)
        {
            ...
            var fields = filteredMembers.Select(e =>
            {
                ...
                return new Field() { Name = e.Name, TypeName = Utils.GetTypeName(e.PropertyType), IsNotInDb = notInDb, IsOnlyInDb = onlyInDb, IsOnlyCreate = onlyCreate, IsPrimaryKey = isPrimaryKey, IsAutogeneratedKey = isAutogenerated, CommentSummary = e.CommentSummary(), ControllerFromHeader = e.ControllerFromHeaderName() };
            }).ToList();
